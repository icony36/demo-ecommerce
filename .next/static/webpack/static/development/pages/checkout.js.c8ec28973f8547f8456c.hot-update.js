...
/* harmony import */ var _components_checkout_utils__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! ../components/checkout/utils */ "./components/checkout/utils.js");
...
var Checkout = function Checkout() {
  ...
  var handleCardInput = function handleCardInput(evt) {
    if (evt.target.name === "cardNum") {
      evt.target.value = Object(_components_checkout_utils__WEBPACK_IMPORTED_MODULE_17__["formatCreditCardNumber"])(evt.target.value);
      setCheckoutInput(evt);
    } else if (evt.target.name === "expiry") {
      evt.target.value = Object(_components_checkout_utils__WEBPACK_IMPORTED_MODULE_17__["formatExpirationDate"])(evt.target.value);
      setCheckoutInput(evt);
    } else if (evt.target.name === "cvc") {
      evt.target.value = Object(_components_checkout_utils__WEBPACK_IMPORTED_MODULE_17__["formatCVC"])(evt.target.value);
      setCheckoutInput(evt);
    }
  };
...
//# sourceMappingURL=checkout.js.c8ec28973f8547f8456c.hot-update.js.map